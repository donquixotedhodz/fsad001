...
try {
    $stmt = $conn->prepare("SELECT date, check_no, dv_or_no, particulars, (debit + credit) as amount FROM ppe WHERE (debit > 0 OR credit > 0) ORDER BY date ASC");
    $stmt->execute();
...
<body>
    ...
    <div class="page">
        ...
        <div style="text-align: left; margin-bottom: 15px;">
            ...
            <h2 style="font-size: 14px; margin-bottom: 5px; text-transform: uppercase;">Check Issued</h2>
