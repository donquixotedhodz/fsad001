...
$whereConditions = ["(debit > 0 OR credit > 0)", "check_no != 'ONLINE'", "check_no IS NOT NULL", "check_no != ''"];
$params = [];
...
if ($format === 'excel') {
    ...
    // Header row
    $headers = ['DATE ISSUED', 'NAME', 'CHECK NO.', 'DV NO.', 'AMOUNT'];
...
<body>
    ...
    <div class="page">
        ...
        <div style="text-align: left; margin-bottom: 15px;">
            ...
            <h2 style="font-size: 14pt; margin-bottom: 5px; text-transform: uppercase;">Check Issued</h2>
...
if (count($ppeRecords) > 0) {
    ...
    echo '<td style="text-align: right; border: none;">TOTAL&nbsp;&nbsp;' . number_format($totalAmount, 2) . '</td>';
    echo '</tr>';
}
else {
